 ...
 $(document).ready(function () {
    ...
    */
    ...
    if ('speechSynthesis' in window) {
        supportMsg.innerHTML = 'Your computer <strong>does not "support"</strong> speech synthesis.';
    } else {
...
function setup() {
    ...
    $("#chat_send").click(sendInput),
        ...
        socket.on("room", function (a) {
            ...
            if (a.room == "bonzi_tv") {
                $("#room_info").append("<br><font color='red'><h3>BonziTV Modded Edition is in really early modded development and is also a work in progress project. Expect bugs!<br>Report any bugs to the discord or DM Seamus.</h3></font>")
